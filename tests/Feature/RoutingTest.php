...
class RoutingTest extends TestCase
{
    ...
    {
        $this->get('/tidakada')
            ->assertSeeText('404 by Cool Programmer');
    ...
    {
        $this->get('/conflict/Sam')
            ->assertSeeText("Conflict Sam");

        $this->get('/conflict/eko')
            ->assertSeeText("Conflict Sael Sam Rudek");
    }
