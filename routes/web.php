...
Route::get('/pzn', function (){
    return "Hello Cool Programmer";
});

Route::redirect('/youtube', '/pzn');

Route::fallback(function (){
    return "404 by Cool Programmer";
});

Route::view('/hello', 'hello', ['name' => 'Sael']);

Route::get('/hello-again', function (){
    return view('hello', ['name' => 'Sael']);
});

Route::get('/hello-world', function (){
    return view('hello.world', ['name' => 'Sael']);
});
...
Route::get('/conflict/sael', function (){
    return "Conflict Sael Sam Rudek";
});
...
Route::get('/redirect/named', function (){
    return \Illuminate\Support\Facades\URL::route('redirect-hello', ['name' => 'Sael']);
});
